...
export const CARD_DEFINITIONS = [
  ...
  { id: 'action-quack', color: 'action', label: '카드를 뽑기 전에, 오리처럼 꽥꽥거려요', image: 'action-quack.png' },
  { id: 'action-tapfloor', color: 'action', label: '카드를 뽑기 전에, 손가락으로 바닥을 건드려요', image: 'action-tapfloor.png' },
  { id: 'action-praise', color: 'action', label: '카드를 뽑기 전에, 누군가를 칭찬해요', image: 'action-praise.png' },
  { id: 'action-liftfeet', color: 'action', label: '카드를 뽑기 전에, 양쪽 발을 들어올려요', image: 'action-liftfeet.png' },
  { id: 'action-sing', color: 'action', label: '카드를 노래하듯 읽어요', image: 'action-sing.png' },
  { id: 'action-shout', color: 'action', label: '카드를 소리지르면서 읽어요', image: 'action-shout.png' },

  // pose: 손가락/몸 자세를 유지
  { id: 'pose-fingertable', color: 'pose', label: '손가락 하나가 탁자와 닿아요', image: 'pose-fingertable.png' },
  { id: 'pose-elbowhigh', color: 'pose', label: '팔꿈치를 내 어깨보다 높이 들어요', image: 'pose-elbowhigh.png' },
  { id: 'pose-handshigh', color: 'pose', label: '오른손을 내 왼손보다 높이 둬요', image: 'pose-handshigh.png' },
